...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertFormError(response, 'form', 'renewal_date', 'Invalid date - renewal more than 4 weeks in the future.')
...
class AuthorCreateViewTest(TestCase):
    ...
    """ Test case for AuthorCreate view. """
    def setUp(self):
        # Create a user
        test_user1 = User.objects.create_user(username='testuser1', password='1X<ISRUkw+tuK')
        test_user2 = User.objects.create_user(username='testuser2', password='2HJ1vRV0Z&3iD')
        ...
        permission = Permission.objects.get(name='Set as book returned')
        test_user2.user_permissions.add(permission)
        test_user2.save()
    ...
    # If logged in but not correct permission
    ...
    # Initial date of death set to expected date 
